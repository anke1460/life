			...
			<div id="item1" class="mui-control-content mui-active">
				<div id="content{{$index}}" class="mui-control-content" :class="{'mui-active': $index == 0}" v-for="classify in classifies">
					...
					<template v-if="classify.is_mark">
						<ul class="mui-table-view" @tap="go(classify)">
							<li class="mui-table-view-cell" v-for="travel in classify.travels">
								<a>
						...
						<ul class="mui-table-view">
							<li class="mui-table-view-cell mui-collapse" v-for="travel in classify.travels">
								...
								<div class="mui-collapse-content">
									<button type="button" class="mui-btn" v-for="attraction in travel.attractions">{{attraction.name}}</button>
								</div>
							</li>
						</ul>
					</template>
